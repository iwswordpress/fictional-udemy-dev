...
/* harmony import */ var _modules_Job__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Job */ "./src/modules/Job.js");
 // Our modules / classes
...
console.log('%cIndex.js firing...', 'color:blue;font-size:18px'); // Instantiate a new object using our modules/classes
...
const job = new _modules_Job__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class Like {
  constructor() {
    console.log('%cLike.js constructor...', 'color:orange;font-size:18px');
