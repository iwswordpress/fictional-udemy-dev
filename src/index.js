...
// import { validEmail, validPassword, emailAvailable, registerEmail } from './modules/helpers';

// console.log(`%cIndex05`, 'color:blue; font-size:18px');
...
// 	console.log(formData.validEmail, formData.validPassword, formData.agree);
// 	if (formData.validEmail && formData.validPassword && formData.agree) {
